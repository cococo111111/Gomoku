...
import com.danielkim.gomokuAI.gomokuAI;
...
public class GomokuFXManager {
     ...
     */
    private SimpleIntegerProperty[][] chessboardProperty = new SimpleIntegerProperty[Chessboard.DEFAULT_SIZE][Chessboard.DEFAULT_SIZE];
     ...
     */
    private SimpleObjectProperty<Class<? extends GomokuAI>> currentPlayerProperty = new SimpleObjectProperty<Class<? extends GomokuAI>>();

    /**
     * chessboard state property, game on, draw, black win, white win.
     */
    private SimpleObjectProperty<ChessboardState> chessboardStateProperty = new SimpleObjectProperty<ChessboardState>(
	    ChessboardState.GAME_ON);

    /**
     * black player strategy class. GomokuAI's subclass if is computer,
     * otherwise null.
     */
    private Class<? extends GomokuAI> blackPlayerStrategyClass;

    /**
     * white player strategy class. GomokuAI's subclass if is computer,
     * otherwise null.
     */
	...
	Task<Point> strategyMoveTask = new Task<Point>() {
		...
		return gomokuAI.next(currentPlayerProperty.get(), chessboard, currentChessType);
	    }
	};
